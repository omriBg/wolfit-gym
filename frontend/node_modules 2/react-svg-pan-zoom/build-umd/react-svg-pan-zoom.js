...
const MODE_IDLE = exports.MODE_IDLE = 'idle';
const MODE_PANNING = exports.MODE_PANNING = 'panning';
const MODE_ZOOMING = exports.MODE_ZOOMING = 'zooming';
const TOOL_AUTO = exports.TOOL_AUTO = 'auto';
const TOOL_NONE = exports.TOOL_NONE = 'none';
const TOOL_PAN = exports.TOOL_PAN = 'pan';
const TOOL_ZOOM_IN = exports.TOOL_ZOOM_IN = 'zoom-in';
const TOOL_ZOOM_OUT = exports.TOOL_ZOOM_OUT = 'zoom-out';
const POSITION_NONE = exports.POSITION_NONE = 'none';
const POSITION_TOP = exports.POSITION_TOP = 'top';
const POSITION_RIGHT = exports.POSITION_RIGHT = 'right';
const POSITION_BOTTOM = exports.POSITION_BOTTOM = 'bottom';
const POSITION_LEFT = exports.POSITION_LEFT = 'left';
const ACTION_ZOOM = exports.ACTION_ZOOM = 'zoom';
const ACTION_PAN = exports.ACTION_PAN = 'pan';
const ALIGN_CENTER = exports.ALIGN_CENTER = 'center';
const ALIGN_LEFT = exports.ALIGN_LEFT = 'left';
const ALIGN_RIGHT = exports.ALIGN_RIGHT = 'right';
const ALIGN_TOP = exports.ALIGN_TOP = 'top';
const ALIGN_BOTTOM = exports.ALIGN_BOTTOM = 'bottom';
const ALIGN_COVER = exports.ALIGN_COVER = 'cover';
const INITIAL_VALUE = exports.INITIAL_VALUE = {};
...
var _viewerMouseEvent = _interopRequireDefault(__webpack_require__(634));
var _viewerTouchEvent = _interopRequireDefault(__webpack_require__(150));
...
exports["default"] = void 0;
var _viewerEvent = _interopRequireDefault(__webpack_require__(460));
var _interactions = __webpack_require__(916);
var _common = __webpack_require__(204);
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
class ViewerMouseEvent extends _viewerEvent.default {
  get point() {
    if (!this._cachePoint) {
      const {
        originalEvent: event,
      ...
      const mousePosition = (0, _interactions.getMousePosition)(event, SVGViewer);
...
var _constants = __webpack_require__(832);
var _transformationMatrix = __webpack_require__(367);
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
...
var _common = __webpack_require__(204);
var _interactions = __webpack_require__(916);
var _zoom = __webpack_require__(430);
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
...
var _constants = __webpack_require__(832);
var _common = __webpack_require__(204);
var _pan = __webpack_require__(14);
var _zoom = __webpack_require__(430);
var _mapRange = _interopRequireDefault(__webpack_require__(192));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
function onMouseDown(event, ViewerDOM, tool, value, props) {
  ...
  switch (tool) {
    case _constants.TOOL_ZOOM_OUT:
      let SVGPoint = (0, _common.getSVGPoint)(value, x, y);
...
function onWheel(event, ViewerDOM, tool, value, props) {
  ...
  let scaleFactor = (0, _mapRange.default)(delta, -1, 1, props.scaleFactorOnWheel, 1 / props.scaleFactorOnWheel);
  let SVGPoint = (0, _common.getSVGPoint)(value, x, y);
  let nextValue = (0, _zoom.zoom)(value, SVGPoint.x, SVGPoint.y, scaleFactor, props);
  event.preventDefault();
  return nextValue;
}
function onMouseEnterOrLeave(event, ViewerDOM, tool, value, props) {
  let coords = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
  let nextValue = (0, _common.setFocus)(value, event.type === 'mouseenter');
  event.preventDefault();
  return nextValue;
}
...
var _constants = __webpack_require__(832);
var _common = __webpack_require__(204);
var _calculateBox = _interopRequireDefault(__webpack_require__(6));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
function zoom(value, SVGPointX, SVGPointY, scaleFactor) {
  ...
  const matrix = (0, _transformationMatrix.transform)((0, _transformationMatrix.fromObject)(value), (0, _transformationMatrix.translate)(SVGPointX, SVGPointY), (0, _transformationMatrix.scale)(scaleFactor, scaleFactor), (0, _transformationMatrix.translate)(-SVGPointX, -SVGPointY));
...
function fitSelection(value, selectionSVGPointX, selectionSVGPointY, selectionWidth, selectionHeight) {
  ...
  const matrix = (0, _transformationMatrix.transform)((0, _transformationMatrix.scale)(scaleLevel, scaleLevel),
  //2
...
function fitToViewer(value) {
  let SVGAlignX = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _constants.ALIGN_LEFT;
  let SVGAlignY = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _constants.ALIGN_TOP;
  let {
    viewerWidth,
    viewerHeight,
    SVGMinX,
  ...
  let scaleLevel = Math.min(scaleX, scaleY);
  let scaleMatrix = (0, _transformationMatrix.scale)(scaleLevel, scaleLevel);
  ...
  const translationMatrix = (0, _transformationMatrix.translate)(translateX, translateY);
  const matrix = (0, _transformationMatrix.transform)(translationMatrix,
  //2
  scaleMatrix //1
  );
  if (isZoomLevelGoingOutOfBounds(value, scaleLevel / value.d)) {
...
function zoomOnViewerCenter(value, scaleFactor) {
  ...
  let SVGPoint = (0, _common.getSVGPoint)(value, viewerWidth / 2, viewerHeight / 2);
...
function stopZooming(value, viewerX, viewerY, scaleFactor) {
  ...
  let start = (0, _common.getSVGPoint)(value, startX, startY);
  let end = (0, _common.getSVGPoint)(value, viewerX, viewerY);
  if (Math.abs(startX - viewerX) > TOLERATED_DISTANCE && Math.abs(startY - viewerY) > TOLERATED_DISTANCE) {
    let box = (0, _calculateBox.default)(start, end);
    return fitSelection(value, box.x, box.y, box.width, box.height);
  } else {
    let SVGPoint = (0, _common.getSVGPoint)(value, viewerX, viewerY);
    return zoom(value, SVGPoint.x, SVGPoint.y, scaleFactor);
  }
}
...
var _viewer = _interopRequireDefault(__webpack_require__(767));
var _uncontrolledViewer = _interopRequireDefault(__webpack_require__(164));
var _toolbar = _interopRequireDefault(__webpack_require__(115));
var _toolbarButton = _interopRequireDefault(__webpack_require__(749));
var _iconCursor = _interopRequireDefault(__webpack_require__(776));
var _iconPan = _interopRequireDefault(__webpack_require__(93));
var _iconFit = _interopRequireDefault(__webpack_require__(85));
var _iconZoomIn = _interopRequireDefault(__webpack_require__(671));
var _iconZoomOut = _interopRequireDefault(__webpack_require__(568));
var _miniature = _interopRequireDefault(__webpack_require__(783));
var _common = __webpack_require__(204);
var _pan = __webpack_require__(14);
var _zoom = __webpack_require__(430);
var _miniature2 = __webpack_require__(389);
var _constants = __webpack_require__(832);
...
var _is = __webpack_require__(935);
...
var _react = _interopRequireDefault(__webpack_require__(442));
var _propTypes = _interopRequireDefault(__webpack_require__(993));
var _constants = __webpack_require__(832);
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
var _react = _interopRequireDefault(__webpack_require__(442));
var _propTypes = _interopRequireDefault(__webpack_require__(993));
var _RandomUID = _interopRequireDefault(__webpack_require__(848));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
var _default = exports["default"] = (0, _RandomUID.default)(MiniatureMask);
...
var _react = _interopRequireDefault(__webpack_require__(442));
var _propTypes = _interopRequireDefault(__webpack_require__(993));
var _miniature = __webpack_require__(389);
var _iconArrow = _interopRequireDefault(__webpack_require__(535));
var _constants = __webpack_require__(832);
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function MiniatureToggleButton(_ref) {
  ...
  let style = {
    ...
    position: "absolute",
    bottom: 0,
    [position === _constants.POSITION_LEFT ? 'left' : 'right']: '0px',
  ...
  let action = value.miniatureOpen ? _miniature.closeMiniature : _miniature.openMiniature;
...
var _constants = __webpack_require__(832);
var _transformationMatrix = __webpack_require__(367);
var _miniatureToggleButton = _interopRequireDefault(__webpack_require__(953));
var _miniatureMask = _interopRequireDefault(__webpack_require__(750));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
function Toolbar(_ref) {
  ...
  let isHorizontal = [_constants.POSITION_TOP, _constants.POSITION_BOTTOM].indexOf(position) >= 0;
  let style = {
    //position
    position: "absolute",
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    name: "unselect-tools",
    title: "Selection",
    onClick: event => handleChangeTool(event, _constants.TOOL_NONE)
    ...
    title: "Pan",
    onClick: event => handleChangeTool(event, _constants.TOOL_PAN)
    ...
    title: "Zoom in",
    onClick: event => handleChangeTool(event, _constants.TOOL_ZOOM_IN)
    ...
    title: "Zoom out",
    onClick: event => handleChangeTool(event, _constants.TOOL_ZOOM_OUT)
...
var _default = exports["default"] = (0, _RandomUID.default)(BorderGradient);
...
function Selection(_ref) {
  ...
  let box = (0, _calculateBox.default)({
    x: startX,
    y: startY
  }, {
    x: endX,
...
class UncontrolledReactSVGPanZoom extends _react.default.Component {
  constructor(props) {
    super(props);
    this.state = {
...
function RandomUID(WrappedComponent) {
  class RandomUID extends _react.default.Component {
    constructor(props) {
      super(props);
      this.state = {
        uid: nextUID()
  ...
  RandomUID.displayName = `RandomUID(${(0, _getDisplayName.default)(WrappedComponent)})`;
  return RandomUID;
}
...
var _propTypes = _interopRequireDefault(__webpack_require__(993));
var _transformationMatrix = __webpack_require__(367);
var _eventFactory = _interopRequireDefault(__webpack_require__(376));
var _pan = __webpack_require__(14);
var _common = __webpack_require__(204);
var _interactions = __webpack_require__(916);
var _parseViewBox = _interopRequireDefault(__webpack_require__(260));
var _interactionsTouch = __webpack_require__(122);
var _zoom = __webpack_require__(430);
var _miniature = __webpack_require__(389);
var _cursorPolyfill = _interopRequireDefault(__webpack_require__(78));
var _borderGradient = _interopRequireDefault(__webpack_require__(113));
var _selection = _interopRequireDefault(__webpack_require__(550));
var _toolbar = _interopRequireDefault(__webpack_require__(115));
var _detectTouch = _interopRequireDefault(__webpack_require__(331));
var _miniature2 = _interopRequireDefault(__webpack_require__(783));
var _constants = __webpack_require__(832);
var _migrationTips = __webpack_require__(248);
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
...
module.exports = __WEBPACK_EXTERNAL_MODULE__993__;
